                ...
                json.dumps(
                    {
                        ...
                        "instruction": (
                            "Answer again. Cite at least one supplied web evidence key "
                            "in square brackets. If the evidence is insufficient, state "
                            "that limitation while citing the evidence that supports it."
                        ),
                        "allowed_web_keys": [
                            item.key
